        ...
        <>
            <footer>
                <div className='bg-[#222831] w-full h-[150px] text-center flex flex-col justify-center'>
                    ...
                    <p className='text-[#EEEEEE] font-gilda text-sm'>Suggestions or issues with the website? Email comments to <a className='underline' href="mailto:sebastianbsanchez67@gmail.com">sebastianbsanchez67@gmail.com</a></p>
